...
class CustomerControllerTests {
    ...
    void testSearchCustomersByNameSubstring() throws Exception {
        when(customerRepository.findAllWithOrdersByNameContaining("oh")).thenReturn(List.of(customer));
    ...
    void testSearchCustomersByNameSubstringNoMatch() throws Exception {
        when(customerRepository.findAllWithOrdersByNameContaining("zzz")).thenReturn(List.of());
